...
![Backlog-Final](../assets/Backlog-Final-Sprint-2.png)
...
| ---- | ------------------------------------------------------------------------------------ | :--------: | :----------: |
| US08 | Como Gerente General, quiero gestionar roles de usuarios para controlar accesos al sistema. | Alta | ✅ Completada |
| US09 | Como Gerente de Inventario, quiero recibir alertas por correo cuando el stock esté bajo mínimos. | Alta | ✅ Completada |
| US10 | Como equipo de desarrollo, necesitamos implementar CI/CD para despliegues automatizados. | Crítica | ✅ Completada |
| US11 | Como administrador, quiero ver un historial de cambios en roles y accesos. | Media | ✅ Completada |
| US12 | Como Gerente de Ventas, quiero asegurar que mi rol solo permita acceder a módulos de ventas y pagos. | Media-Alta | ✅ Completada |
| US13 | Como equipo, debemos completar funcionalidades pendientes del MVP. | Alta | ✅ Completada |
| US14 | Como tester, necesito ejecutar pruebas de aceptación antes del despliegue final. | Media | ✅ Completada |