                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-start">
                    ...
                    <button
                        ...
                        [ngClass]="{ 'outline-primary': primaryColor.name === selectedPrimaryColor() }"
                            ...
                            [style]="{
                    'background-color': primaryColor?.name === 'noir' ? 'var(--text-color)' :
            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-start">
                    ...
                    <button
                        ...
                        [ngClass]="{ 'outline-primary': selectedSurfaceColor() ? selectedSurfaceColor() ===
                    surface.name : layoutService.layoutConfig().darkTheme ? surface.name === 'zinc' : surface.name ===
                    'slate' }"
                            class="border-none w-5 h-5 rounded-full p-0 cursor-pointer outline-none outline-offset-1"
                            [style]="{
